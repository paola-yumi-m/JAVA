...
public class TaskDialogScreenUpdate extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanelHeaderLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelHeaderLayout.createSequentialGroup()
                ...
                .addComponent(jLabelId, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jLabelHeaderAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelHeaderAddMouseClicked
        ...
        try {
            if (jTextFieldName.getText().isEmpty() || 
                ...
                edited.setId(Integer.parseInt(jLabelId.getText()));
                edited.setIdProject(project.getId());
                edited.setName(jTextFieldName.getText());
                edited.setDescription(jTextAreaDescription.getText());
                edited.setNotes(jTextAreaNotes.getText());
                edited.setIsCompleted(false);
                SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                edited.setDeadline(dateFormat.parse(
    ...
    public void setTaskId(Task task) {
        jLabelId.setText(Integer.toString(task.getId()));
        jLabelId.setForeground(new Color(0, 153, 102));
    }
